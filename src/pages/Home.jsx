          ...
          <Row>
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <h2>Make Your Interior More Stylish & Elegant</h2>
                <p>
                  Meet our best selling items, feel the vibes of modern design.
                  This trending collection is inspired by the natural beauty of
                  nature.
                </p>
          ...
          <Row>
            <Col lg="6" md="12" className="count__down-col">
              <div className="clock__top-content">
                ...
                <h3 className="fs-5 mb-3">Upholstered Swivel Armchair</h3>
              </div>
              <Clock />
